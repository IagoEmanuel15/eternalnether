...
import com.izofar.bygonenether.world.entity.monster.WitherSkeletonKnight;
...
public class WitherSkeletonKnightModel extends HumanoidModel<WitherSkeletonKnight> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        leftArm.addOrReplaceChild("left_armwear",
                CubeListBuilder.create()
                        .texOffs(40, 32)
                        .mirror()
                        .addBox(3.0F, -4.0F, -1.5F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.4F))
                        .mirror(false),
                PartPose.offset(-3.0F, 2.0F, 0.0F));
        rightArm.addOrReplaceChild("right_armwear",
                CubeListBuilder.create()
                        .texOffs(40, 32)
                        .addBox(-9.0F, -4.0F, -1.5F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.4F)),
                PartPose.offset(5.0F, 2.0F, 0.0F));
        leftLeg.addOrReplaceChild("left_legwear",
                CubeListBuilder.create()
                        .texOffs(0, 32)
                        .mirror()
                        .addBox(0.0F, -12.0F, -2.1F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.1F))
                        .mirror(false),
                PartPose.offset(-2.0F, 12.0F, 0.1F));
        rightLeg.addOrReplaceChild("right_legwear",
                CubeListBuilder.create()
                        .texOffs(0, 32)
                        .addBox(-4.0F, -12.0F, -2.1F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.1F)),
                PartPose.offset(2.0F, 12.0F, 0.1F));

...
public class CitadelStructure extends Structure {
    public static final MapCodec<CitadelStructure> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            CitadelStructure.settingsCodec(instance),
            ...
            Codec.intRange(1, 128)
                    ...
                    .forGetter(structure -> structure.maxDistanceFromCenter)).apply(instance, CitadelStructure::new));
    ...
    public CitadelStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter) {
        super(config);
